<?php
/**
 * Файл, определяющий статический класс-валидатор полей формы
 * 
 * PHP version 7
 * 
...
{
    /**
     * Проверка того, что данные в строке являются натуральным числом
     *
     * @param string $orderId ID операции, введенный пользователем
     *
     * @return bool данные в строке являются натуральным числом?
     */
